...
class ChallengesAdapter extends RecyclerView.Adapter<ChallengesAdapter.ViewHolder>{
    ...
    ChallengesAdapter(List<Challenge> challenges, OnChallengeClickedListener listener){
